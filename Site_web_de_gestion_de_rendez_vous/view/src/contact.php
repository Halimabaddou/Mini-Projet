...
<body>
    ...
    <section class="section testimonials is-medium is-white has-text-centered has-border-top">
      <div class="container is-narrow">
        <h1 class="title is-spaced is-size-3-desktop is-size-4-mobile">halima baddou</h1>
        <h2 class="subtitle is-size-5-desktop">POUR PLUS D'INFORMATIONS, N'HSITEZ PAS A NOUS CONTACTEZ 
        <div class="columns is-centered"></h2>
          <div class="column is-two-thirds">
                <div class="carousel-inner">
                  <div class="carousel-item">
                    <div class="testimonial-block">
                      <h1 class="title is-size-6">Adresse email: NourAlHayat@gmail.com</h1>
                      <h2 class="subtitle is-size-6"></h2>
                    </div>
                  </div>
                </div>
          </div>
