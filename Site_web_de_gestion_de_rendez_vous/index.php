...
<body>
    ...
    <section class="hero is-large is-bold" style="background-image: url('view/images/background.png'); background-position: left center; background-repeat: no-repeat; background-size: cover;">
      <hr>
      <div class="hero-body">
        <div class="container">
          ...
          <h2 class="subtitle">
            Optimisez la gestion de vos rendez-vous avec un outil simple Nour Al Hayat, <br>
             et efficace pour les hôpitaux modernes.
          </h2>
        </div>
      </div>
    </section>
